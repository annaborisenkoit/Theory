...
$opt_name = 'theory_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'theory' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'theory' ),
