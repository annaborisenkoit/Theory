...
class Elementor_Slider_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theory Slider', 'theory-core' );
	}
        ...
        if ( $settings['slider'] ) {
            ...
            foreach (  $settings['slider'] as $index => $item ) {
                ...
                <div class="carousel-item<?php echo $active_class; ?>">
                    <img class="w-100" src="<?php echo esc_url($item['theo_image']['url']); ?>">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3"><?php echo esc_html($item['theo_title_one']); ?></h4>
                            <h1 class="display-1 text-white mb-md-4"><?php echo esc_html($item['theo_title_two']); ?></h1>
