    ...
    <div class="row">
        <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center">
                <?php if (isset($theory_options['phone'])) { ?>
                    <a class="text-body pr-3" href="tel:<?php echo esc_html($theory_options['phone']); ?>"><i class="fa fa-phone-alt mr-2"></i><?php echo esc_html($theory_options['phone']); ?></a>
                    <span class="text-body">|</span>
                <?php } ?>
                <?php if (isset($theory_options['email'])) { ?>
...
<?php if (!is_front_page()) { 
    $bg_image = '';
    if (isset($theory_options['heading_image']['url']) && $theory_options['heading_image']['url']) {
